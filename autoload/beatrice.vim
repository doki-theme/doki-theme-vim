...
let g:beatrice#palette.fg        = ['#F8F8F2', 253]

let g:beatrice#palette.bglighter = ['#424450', 238]
let g:beatrice#palette.bglight   = ['#343746', 237]
let g:beatrice#palette.bg        = ['#282A36', 236]
let g:beatrice#palette.bgdark    = ['#21222C', 235]
let g:beatrice#palette.bgdarker  = ['#191A21', 234]
