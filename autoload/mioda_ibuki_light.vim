...
let g:mioda_ibuki_light#palette.subtle    = ['#424450', 238]

let g:mioda_ibuki_light#palette.cyan      = ['#8BE9FD', 117]
let g:mioda_ibuki_light#palette.green     = ['#50FA7B',  84]
let g:mioda_ibuki_light#palette.orange    = ['#FFB86C', 215]
let g:mioda_ibuki_light#palette.pink      = ['#FF79C6', 212]
let g:mioda_ibuki_light#palette.purple    = ['#BD93F9', 141]
let g:mioda_ibuki_light#palette.red       = ['#FF5555', 203]
let g:mioda_ibuki_light#palette.yellow    = ['#F1FA8C', 228]
