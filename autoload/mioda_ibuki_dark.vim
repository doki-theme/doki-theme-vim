...
let g:mioda_ibuki_dark#palette.subtle    = ['#424450', 238]

let g:mioda_ibuki_dark#palette.cyan      = ['#8BE9FD', 117]
let g:mioda_ibuki_dark#palette.green     = ['#50FA7B',  84]
let g:mioda_ibuki_dark#palette.orange    = ['#FFB86C', 215]
let g:mioda_ibuki_dark#palette.pink      = ['#FF79C6', 212]
let g:mioda_ibuki_dark#palette.purple    = ['#BD93F9', 141]
let g:mioda_ibuki_dark#palette.red       = ['#FF5555', 203]
let g:mioda_ibuki_dark#palette.yellow    = ['#F1FA8C', 228]
