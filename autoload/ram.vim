...
let g:ram#palette           = {}
let g:ram#palette.fg        = ['#F8F8F2', 253]

let g:ram#palette.bglighter = ['#424450', 238]
let g:ram#palette.bglight   = ['#343746', 237]
let g:ram#palette.bg        = ['#282A36', 236]
let g:ram#palette.bgdark    = ['#21222C', 235]
let g:ram#palette.bgdarker  = ['#191A21', 234]

let g:ram#palette.comment   = ['#6272A4',  61]
let g:ram#palette.selection = ['#44475A', 239]
let g:ram#palette.subtle    = ['#424450', 238]

let g:ram#palette.cyan      = ['#8BE9FD', 117]
let g:ram#palette.green     = ['#50FA7B',  84]
let g:ram#palette.orange    = ['#FFB86C', 215]
let g:ram#palette.pink      = ['#FF79C6', 212]
let g:ram#palette.purple    = ['#BD93F9', 141]
let g:ram#palette.red       = ['#FF5555', 203]
let g:ram#palette.yellow    = ['#F1FA8C', 228]
