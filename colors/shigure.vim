...
if !exists("g:shigure_termcolors")
  let g:shigure_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:shigure_terminal_italics")
  let g:shigure_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:shigure_terminal_italics == 0
...
let s:colors = shigure#GetColors() " Autoloaded from the specific color theme
