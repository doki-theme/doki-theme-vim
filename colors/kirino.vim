...
if !exists("g:kirino_termcolors")
  let g:kirino_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:kirino_terminal_italics")
  let g:kirino_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:kirino_terminal_italics == 0
...
let s:colors = kirino#GetColors() " Autoloaded from the specific color theme
