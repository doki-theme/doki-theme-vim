...
if !exists("g:sagiri_termcolors")
  let g:sagiri_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:sagiri_terminal_italics")
  let g:sagiri_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:sagiri_terminal_italics == 0
...
let s:colors = sagiri#GetColors() " Autoloaded from the specific color theme
