...
if !exists("g:mai_light_termcolors")
  let g:mai_light_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:mai_light_terminal_italics")
  let g:mai_light_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:mai_light_terminal_italics == 0
...
let s:colors = mai_light#GetColors() " Autoloaded from the specific color theme
