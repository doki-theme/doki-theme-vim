...
if !exists("g:hanekawa_tsubasa_termcolors")
  let g:hanekawa_tsubasa_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:hanekawa_tsubasa_terminal_italics")
  let g:hanekawa_tsubasa_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:hanekawa_tsubasa_terminal_italics == 0
  ...
  if g:hanekawa_tsubasa_termcolors == 16
...
let s:colors = hanekawa_tsubasa#GetColors() " Autoloaded from the specific color theme
