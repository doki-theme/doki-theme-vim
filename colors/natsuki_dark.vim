...
if !exists("g:natsuki_dark_termcolors")
  let g:natsuki_dark_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:natsuki_dark_terminal_italics")
  let g:natsuki_dark_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:natsuki_dark_terminal_italics == 0
  ...
  if g:natsuki_dark_termcolors == 16
...
let s:colors = natsuki_dark#GetColors() " Autoloaded from the specific color theme
