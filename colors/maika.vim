...
if !exists("g:maika_termcolors")
  let g:maika_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:maika_terminal_italics")
  let g:maika_terminal_italics = 0
endif
...
let s:colors = maika#GetColors() " Autoloaded from the specific color theme
