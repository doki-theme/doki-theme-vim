...
if !exists("g:beatrice_termcolors")
  let g:beatrice_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:beatrice_terminal_italics")
  let g:beatrice_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:beatrice_terminal_italics == 0
...
let s:colors = beatrice#GetColors() " Autoloaded from the specific color theme
