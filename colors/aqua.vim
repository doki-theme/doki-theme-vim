...
if !exists("g:aqua_termcolors")
  let g:aqua_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:aqua_terminal_italics")
  let g:aqua_terminal_italics = 0
endif
...
let s:colors = aqua#GetColors() " Autoloaded from the specific color theme
