...
if !exists("g:coconut_termcolors")
  let g:coconut_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:coconut_terminal_italics")
  let g:coconut_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:coconut_terminal_italics == 0
...
let s:colors = coconut#GetColors() " Autoloaded from the specific color theme
