...
let g:colors_name = 'darkness-dark'
...
let s:fg        = g:darkness-dark#palette.fg

let s:bglighter = g:darkness-dark#palette.bglighter
let s:bglight   = g:darkness-dark#palette.bglight
let s:bg        = g:darkness-dark#palette.bg
let s:bgdark    = g:darkness-dark#palette.bgdark
let s:bgdarker  = g:darkness-dark#palette.bgdarker

let s:comment   = g:darkness-dark#palette.comment
let s:selection = g:darkness-dark#palette.selection
let s:subtle    = g:darkness-dark#palette.subtle

let s:cyan      = g:darkness-dark#palette.cyan
let s:green     = g:darkness-dark#palette.green
let s:orange    = g:darkness-dark#palette.orange
let s:pink      = g:darkness-dark#palette.pink
let s:purple    = g:darkness-dark#palette.purple
let s:red       = g:darkness-dark#palette.red
let s:yellow    = g:darkness-dark#palette.yellow

let s:none      = ['NONE', 'NONE']

if has('nvim')
  for s:i in range(16)
    let g:terminal_color_{s:i} = g:darkness-dark#palette['color_' . s:i]
  endfor
endif
...
if has('terminal')
  ...
  for s:i in range(16)
    call add(g:terminal_ansi_colors, g:darkness-dark#palette['color_' . s:i])
  endfor
endif
...
if !exists('g:darkness-dark_bold')
  let g:darkness-dark_bold = 1
endif

if !exists('g:darkness-dark_italic')
  let g:darkness-dark_italic = 1
endif

if !exists('g:darkness-dark_underline')
  let g:darkness-dark_underline = 1
endif

if !exists('g:darkness-dark_undercurl') && g:darkness-dark_underline != 0
  let g:darkness-dark_undercurl = 1
endif

if !exists('g:darkness-dark_inverse')
  let g:darkness-dark_inverse = 1
endif

if !exists('g:darkness-dark_colorterm')
  let g:darkness-dark_colorterm = 1
endif
...
let s:attrs = {
      \ 'bold': g:darkness-dark_bold == 1 ? 'bold' : 0,
      \ 'italic': g:darkness-dark_italic == 1 ? 'italic' : 0,
      \ 'underline': g:darkness-dark_underline == 1 ? 'underline' : 0,
      \ 'undercurl': g:darkness-dark_undercurl == 1 ? 'undercurl' : 0,
      \ 'inverse': g:darkness-dark_inverse == 1 ? 'inverse' : 0,
      \}
...
call s:h('DarknessDarkYellow', s:yellow)
call s:h('DarknessDarkYellowItalic', s:yellow, s:none, [s:attrs.italic])
...
call s:h('Normal', s:fg, g:darkness-dark_colorterm || has('gui_running') ? s:bg : s:none )
...
hi! link CursorLineNr DarknessDarkYellow
...
hi! link String DarknessDarkYellow
