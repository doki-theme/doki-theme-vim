...
if !exists("g:astolfo_termcolors")
  let g:astolfo_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:astolfo_terminal_italics")
  let g:astolfo_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:astolfo_terminal_italics == 0
...
let s:colors = astolfo#GetColors() " Autoloaded from the specific color theme
