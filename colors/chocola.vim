...
if !exists("g:chocola_termcolors")
  let g:chocola_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:chocola_terminal_italics")
  let g:chocola_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:chocola_terminal_italics == 0
...
let s:colors = chocola#GetColors() " Autoloaded from the specific color theme
