...
if !exists("g:echidna_termcolors")
  let g:echidna_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:echidna_terminal_italics")
  let g:echidna_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:echidna_terminal_italics == 0
...
let s:colors = echidna#GetColors() " Autoloaded from the specific color theme
