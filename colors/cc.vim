...
if !exists("g:cc_termcolors")
  let g:cc_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:cc_terminal_italics")
  let g:cc_terminal_italics = 0
endif
...
let s:colors = cc#GetColors() " Autoloaded from the specific color theme
