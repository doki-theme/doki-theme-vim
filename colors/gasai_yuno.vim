...
if !exists("g:gasai_yuno_termcolors")
  let g:gasai_yuno_termcolors = 256
endif
...
function! s:h(group, style, ...)
  ...
  if g:gasai_yuno_terminal_italics == 0
...
let s:colors = gasai_yuno#GetColors() " Autoloaded from the specific color theme
