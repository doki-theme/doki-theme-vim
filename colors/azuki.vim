...
if !exists("g:azuki_termcolors")
  let g:azuki_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:azuki_terminal_italics")
  let g:azuki_terminal_italics = 0
endif
...
let s:colors = azuki#GetColors() " Autoloaded from the specific color theme
