...
if !exists("g:konata_termcolors")
  let g:konata_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:konata_terminal_italics")
  let g:konata_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:konata_terminal_italics == 0
...
let s:colors = konata#GetColors() " Autoloaded from the specific color theme
