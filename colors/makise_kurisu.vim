...
if !exists("g:makise_kurisu_termcolors")
  let g:makise_kurisu_termcolors = 256
endif
...
function! s:h(group, style, ...)
  ...
  if g:makise_kurisu_terminal_italics == 0
  ...
  if g:makise_kurisu_termcolors == 16
...
let s:colors = makise_kurisu#GetColors() " Autoloaded from the specific color theme
