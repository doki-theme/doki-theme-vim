...
if !exists("g:rem_termcolors")
  let g:rem_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:rem_terminal_italics")
  let g:rem_terminal_italics = 0
endif
...
let s:colors = rem#GetColors() " Autoloaded from the specific color theme
