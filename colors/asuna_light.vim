...
if !exists("g:asuna_light_termcolors")
  let g:asuna_light_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:asuna_light_terminal_italics")
  let g:asuna_light_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:asuna_light_terminal_italics == 0
  ...
  if g:asuna_light_termcolors == 16
...
let s:colors = asuna_light#GetColors() " Autoloaded from the specific color theme
