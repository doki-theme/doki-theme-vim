...
if !exists("g:tohsaka_rin_termcolors")
  let g:tohsaka_rin_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:tohsaka_rin_terminal_italics")
  let g:tohsaka_rin_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:tohsaka_rin_terminal_italics == 0
  ...
  if g:tohsaka_rin_termcolors == 16
...
let s:colors = tohsaka_rin#GetColors() " Autoloaded from the specific color theme
