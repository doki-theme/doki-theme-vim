...
if !exists("g:gray_termcolors")
  let g:gray_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:gray_terminal_italics")
  let g:gray_terminal_italics = 0
endif
...
let s:colors = gray#GetColors() " Autoloaded from the specific color theme
