...
if !exists("g:hiro_termcolors")
  let g:hiro_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:hiro_terminal_italics")
  let g:hiro_terminal_italics = 0
endif
...
let s:colors = hiro#GetColors() " Autoloaded from the specific color theme
