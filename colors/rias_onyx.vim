...
if !exists("g:rias_onyx_termcolors")
  let g:rias_onyx_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:rias_onyx_terminal_italics")
  let g:rias_onyx_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:rias_onyx_terminal_italics == 0
...
let s:colors = rias_onyx#GetColors() " Autoloaded from the specific color theme
