...
if !exists("g:maple_dark_termcolors")
  let g:maple_dark_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:maple_dark_terminal_italics")
  let g:maple_dark_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:maple_dark_terminal_italics == 0
...
let s:colors = maple_dark#GetColors() " Autoloaded from the specific color theme
