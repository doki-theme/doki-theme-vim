...
if !exists("g:vanilla_termcolors")
  let g:vanilla_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:vanilla_terminal_italics")
  let g:vanilla_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:vanilla_terminal_italics == 0
...
let s:colors = vanilla#GetColors() " Autoloaded from the specific color theme
