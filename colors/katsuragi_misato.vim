...
if !exists("g:katsuragi_misato_termcolors")
  let g:katsuragi_misato_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:katsuragi_misato_terminal_italics")
  let g:katsuragi_misato_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:katsuragi_misato_terminal_italics == 0
  ...
  if g:katsuragi_misato_termcolors == 16
...
let s:colors = katsuragi_misato#GetColors() " Autoloaded from the specific color theme
