...
if !exists("g:rias_crimson_termcolors")
  let g:rias_crimson_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:rias_crimson_terminal_italics")
  let g:rias_crimson_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:rias_crimson_terminal_italics == 0
  ...
  if g:rias_crimson_termcolors == 16
...
let s:colors = rias_crimson#GetColors() " Autoloaded from the specific color theme
