...
let g:colors_name = 'nakano_itsuki'
...
if !exists("g:nakano_itsuki_termcolors")
  let g:nakano_itsuki_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:nakano_itsuki_terminal_italics")
  let g:nakano_itsuki_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:nakano_itsuki_terminal_italics == 0
  ...
  if g:nakano_itsuki_termcolors == 16
...
let s:colors = nakano_itsuki#GetColors() " Autoloaded from the specific color theme
