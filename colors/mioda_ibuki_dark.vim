...
if !exists("g:mioda_ibuki_dark_termcolors")
  let g:mioda_ibuki_dark_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:mioda_ibuki_dark_terminal_italics")
  let g:mioda_ibuki_dark_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:mioda_ibuki_dark_terminal_italics == 0
  ...
  if g:mioda_ibuki_dark_termcolors == 16
...
let s:colors = mioda_ibuki_dark#GetColors() " Autoloaded from the specific color theme
