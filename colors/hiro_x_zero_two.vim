...
let g:colors_name = 'hiro_x_zero_two'
...
if !exists("g:hiro_x_zero_two_termcolors")
  let g:hiro_x_zero_two_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:hiro_x_zero_two_terminal_italics")
  let g:hiro_x_zero_two_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:hiro_x_zero_two_terminal_italics == 0
  ...
  if g:hiro_x_zero_two_termcolors == 16
...
let s:colors = hiro_x_zero_two#GetColors() " Autoloaded from the specific color theme
