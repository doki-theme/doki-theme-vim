...
if !exists("g:satsuki_light_termcolors")
  let g:satsuki_light_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:satsuki_light_terminal_italics")
  let g:satsuki_light_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:satsuki_light_terminal_italics == 0
  ...
  if g:satsuki_light_termcolors == 16
...
let s:colors = satsuki_light#GetColors() " Autoloaded from the specific color theme
