...
let g:colors_name = 'yukihira_soma'
...
if !exists("g:yukihira_soma_termcolors")
  let g:yukihira_soma_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:yukihira_soma_terminal_italics")
  let g:yukihira_soma_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:yukihira_soma_terminal_italics == 0
  ...
  if g:yukihira_soma_termcolors == 16
...
let s:colors = yukihira_soma#GetColors() " Autoloaded from the specific color theme
