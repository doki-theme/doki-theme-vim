...
let g:colors_name = 'zero_two_light_lily'
...
if !exists("g:zero_two_light_lily_termcolors")
  let g:zero_two_light_lily_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:zero_two_light_lily_terminal_italics")
  let g:zero_two_light_lily_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:zero_two_light_lily_terminal_italics == 0
  ...
  if g:zero_two_light_lily_termcolors == 16
...
let s:colors = zero_two_light_lily#GetColors() " Autoloaded from the specific color theme
