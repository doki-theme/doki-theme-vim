...
if !exists("g:asuna_dark_termcolors")
  let g:asuna_dark_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:asuna_dark_terminal_italics")
  let g:asuna_dark_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:asuna_dark_terminal_italics == 0
...
let s:colors = asuna_dark#GetColors() " Autoloaded from the specific color theme
