...
if !exists("g:megumin_termcolors")
  let g:megumin_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:megumin_terminal_italics")
  let g:megumin_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:megumin_terminal_italics == 0
...
let s:colors = megumin#GetColors() " Autoloaded from the specific color theme
