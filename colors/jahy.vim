...
if !exists("g:jahy_termcolors")
  let g:jahy_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:jahy_terminal_italics")
  let g:jahy_terminal_italics = 0
endif
...
let s:colors = jahy#GetColors() " Autoloaded from the specific color theme
