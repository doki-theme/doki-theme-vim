...
let g:colors_name = 'hinata_shoyo'
...
if !exists("g:hinata_shoyo_termcolors")
  let g:hinata_shoyo_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:hinata_shoyo_terminal_italics")
  let g:hinata_shoyo_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:hinata_shoyo_terminal_italics == 0
  ...
  if g:hinata_shoyo_termcolors == 16
...
let s:colors = hinata_shoyo#GetColors() " Autoloaded from the specific color theme
