...
if !exists("g:sonoda_umi_termcolors")
  let g:sonoda_umi_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:sonoda_umi_terminal_italics")
  let g:sonoda_umi_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:sonoda_umi_terminal_italics == 0
...
let s:colors = sonoda_umi#GetColors() " Autoloaded from the specific color theme
