...
if !exists("g:rei_termcolors")
  let g:rei_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:rei_terminal_italics")
  let g:rei_terminal_italics = 0
endif
...
let s:colors = rei#GetColors() " Autoloaded from the specific color theme
