...
if !exists("g:rory_mercury_termcolors")
  let g:rory_mercury_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:rory_mercury_terminal_italics")
  let g:rory_mercury_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:rory_mercury_terminal_italics == 0
  ...
  if g:rory_mercury_termcolors == 16
...
let s:colors = rory_mercury#GetColors() " Autoloaded from the specific color theme
