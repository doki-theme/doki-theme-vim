...
if !exists("g:essex_termcolors")
  let g:essex_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:essex_terminal_italics")
  let g:essex_terminal_italics = 0
endif
...
let s:colors = essex#GetColors() " Autoloaded from the specific color theme
