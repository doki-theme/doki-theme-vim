...
if !exists("g:cinnamon_termcolors")
  let g:cinnamon_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:cinnamon_terminal_italics")
  let g:cinnamon_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:cinnamon_terminal_italics == 0
...
let s:colors = cinnamon#GetColors() " Autoloaded from the specific color theme
