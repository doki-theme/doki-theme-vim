...
if !exists("g:tomori_nao_termcolors")
  let g:tomori_nao_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:tomori_nao_terminal_italics")
  let g:tomori_nao_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:tomori_nao_terminal_italics == 0
...
let s:colors = tomori_nao#GetColors() " Autoloaded from the specific color theme
