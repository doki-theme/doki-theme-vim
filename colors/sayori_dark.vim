...
if !exists("g:sayori_dark_termcolors")
  let g:sayori_dark_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:sayori_dark_terminal_italics")
  let g:sayori_dark_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:sayori_dark_terminal_italics == 0
  ...
  if g:sayori_dark_termcolors == 16
...
let s:colors = sayori_dark#GetColors() " Autoloaded from the specific color theme
