...
if !exists("g:tohru_termcolors")
  let g:tohru_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:tohru_terminal_italics")
  let g:tohru_terminal_italics = 0
endif
...
let s:colors = tohru#GetColors() " Autoloaded from the specific color theme
