...
let g:colors_name = 'yuzuriha_inori'
...
if !exists("g:yuzuriha_inori_termcolors")
  let g:yuzuriha_inori_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:yuzuriha_inori_terminal_italics")
  let g:yuzuriha_inori_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:yuzuriha_inori_terminal_italics == 0
  ...
  if g:yuzuriha_inori_termcolors == 16
...
let s:colors = yuzuriha_inori#GetColors() " Autoloaded from the specific color theme
