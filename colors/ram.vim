...
if !exists("g:ram_termcolors")
  let g:ram_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:ram_terminal_italics")
  let g:ram_terminal_italics = 0
endif
...
let s:colors = ram#GetColors() " Autoloaded from the specific color theme
