...
if !exists("g:hatsune_miku_termcolors")
  let g:hatsune_miku_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:hatsune_miku_terminal_italics")
  let g:hatsune_miku_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:hatsune_miku_terminal_italics == 0
  ...
  if g:hatsune_miku_termcolors == 16
...
let s:colors = hatsune_miku#GetColors() " Autoloaded from the specific color theme
