...
if !exists("g:yukinoshita_yukino_termcolors")
  let g:yukinoshita_yukino_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:yukinoshita_yukino_terminal_italics")
  let g:yukinoshita_yukino_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:yukinoshita_yukino_terminal_italics == 0
  ...
  if g:yukinoshita_yukino_termcolors == 16
...
let s:colors = yukinoshita_yukino#GetColors() " Autoloaded from the specific color theme
...
call s:h("StatusLine", {"fg": s:colors.infoForeground, "bg": s:colors.lightEditorColor})
call s:h("StatusLineNc", {"fg": s:colors.unusedColor, "bg": s:colors.lightEditorColor})
