...
let g:colors_name = 'emilia-light'
...
let s:fg        = g:emilia-light#palette.fg

let s:bglighter = g:emilia-light#palette.bglighter
let s:bglight   = g:emilia-light#palette.bglight
let s:bg        = g:emilia-light#palette.bg
let s:bgdark    = g:emilia-light#palette.bgdark
let s:bgdarker  = g:emilia-light#palette.bgdarker

let s:comment   = g:emilia-light#palette.comment
let s:selection = g:emilia-light#palette.selection
let s:subtle    = g:emilia-light#palette.subtle

let s:cyan      = g:emilia-light#palette.cyan
let s:green     = g:emilia-light#palette.green
let s:orange    = g:emilia-light#palette.orange
let s:pink      = g:emilia-light#palette.pink
let s:purple    = g:emilia-light#palette.purple
let s:red       = g:emilia-light#palette.red
let s:yellow    = g:emilia-light#palette.yellow

let s:none      = ['NONE', 'NONE']

if has('nvim')
  for s:i in range(16)
    let g:terminal_color_{s:i} = g:emilia-light#palette['color_' . s:i]
  endfor
endif
...
if has('terminal')
  ...
  for s:i in range(16)
    call add(g:terminal_ansi_colors, g:emilia-light#palette['color_' . s:i])
  endfor
endif
...
if !exists('g:emilia-light_bold')
  let g:emilia-light_bold = 1
endif

if !exists('g:emilia-light_italic')
  let g:emilia-light_italic = 1
endif

if !exists('g:emilia-light_underline')
  let g:emilia-light_underline = 1
endif

if !exists('g:emilia-light_undercurl') && g:emilia-light_underline != 0
  let g:emilia-light_undercurl = 1
endif

if !exists('g:emilia-light_inverse')
  let g:emilia-light_inverse = 1
endif

if !exists('g:emilia-light_colorterm')
  let g:emilia-light_colorterm = 1
endif
...
let s:attrs = {
      \ 'bold': g:emilia-light_bold == 1 ? 'bold' : 0,
      \ 'italic': g:emilia-light_italic == 1 ? 'italic' : 0,
      \ 'underline': g:emilia-light_underline == 1 ? 'underline' : 0,
      \ 'undercurl': g:emilia-light_undercurl == 1 ? 'undercurl' : 0,
      \ 'inverse': g:emilia-light_inverse == 1 ? 'inverse' : 0,
      \}
...
call s:h('EmiliaLightYellow', s:yellow)
call s:h('EmiliaLightYellowItalic', s:yellow, s:none, [s:attrs.italic])
...
call s:h('Normal', s:fg, g:emilia-light_colorterm || has('gui_running') ? s:bg : s:none )
...
hi! link CursorLineNr EmiliaLightYellow
...
hi! link String EmiliaLightYellow
