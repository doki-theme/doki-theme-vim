...
if !exists("g:kanna_termcolors")
  let g:kanna_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:kanna_terminal_italics")
  let g:kanna_terminal_italics = 0
endif
...
let s:colors = kanna#GetColors() " Autoloaded from the specific color theme
