...
if !exists("g:hayase_nagatoro_termcolors")
  let g:hayase_nagatoro_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:hayase_nagatoro_terminal_italics")
  let g:hayase_nagatoro_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:hayase_nagatoro_terminal_italics == 0
  ...
  if g:hayase_nagatoro_termcolors == 16
