...
if !exists("g:ryuko_dark_termcolors")
  let g:ryuko_dark_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:ryuko_dark_terminal_italics")
  let g:ryuko_dark_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:ryuko_dark_terminal_italics == 0
...
let s:colors = ryuko_dark#GetColors() " Autoloaded from the specific color theme
