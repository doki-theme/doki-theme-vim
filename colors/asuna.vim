...
let s:yellow    = g:asuna#palette.yellow
...
call s:h('AsunaYellow', s:yellow)
call s:h('AsunaYellowItalic', s:yellow, s:none, [s:attrs.italic])
...
hi! link CursorLineNr AsunaYellow
