...
if !exists("g:miia_termcolors")
  let g:miia_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:miia_terminal_italics")
  let g:miia_terminal_italics = 0
endif
...
let s:colors = miia#GetColors() " Autoloaded from the specific color theme
