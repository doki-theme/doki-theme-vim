...
if !exists("g:jabami_yumeko_termcolors")
  let g:jabami_yumeko_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:jabami_yumeko_terminal_italics")
  let g:jabami_yumeko_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:jabami_yumeko_terminal_italics == 0
  ...
  if g:jabami_yumeko_termcolors == 16
...
let s:colors = jabami_yumeko#GetColors() " Autoloaded from the specific color theme
