...
let g:colors_name = 'zero_two_dark_rose'
...
if !exists("g:zero_two_dark_rose_termcolors")
  let g:zero_two_dark_rose_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:zero_two_dark_rose_terminal_italics")
  let g:zero_two_dark_rose_terminal_italics = 0
endif
...
function! s:h(group, style, ...)
  ...
  if g:zero_two_dark_rose_terminal_italics == 0
  ...
  if g:zero_two_dark_rose_termcolors == 16
...
let s:colors = zero_two_dark_rose#GetColors() " Autoloaded from the specific color theme
