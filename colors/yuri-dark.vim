...
let s:fg        = g:yuri-dark#palette.fg

let s:bglighter = g:yuri-dark#palette.bglighter
let s:bglight   = g:yuri-dark#palette.bglight
let s:bg        = g:yuri-dark#palette.bg
let s:bgdark    = g:yuri-dark#palette.bgdark
let s:bgdarker  = g:yuri-dark#palette.bgdarker

let s:comment   = g:yuri-dark#palette.comment
let s:selection = g:yuri-dark#palette.selection
let s:subtle    = g:yuri-dark#palette.subtle

let s:cyan      = g:yuri-dark#palette.cyan
let s:green     = g:yuri-dark#palette.green
let s:orange    = g:yuri-dark#palette.orange
let s:pink      = g:yuri-dark#palette.pink
let s:purple    = g:yuri-dark#palette.purple
let s:red       = g:yuri-dark#palette.red
let s:yellow    = g:yuri-dark#palette.yellow

let s:none      = ['NONE', 'NONE']

if has('nvim')
  for s:i in range(16)
    let g:terminal_color_{s:i} = g:yuri-dark#palette['color_' . s:i]
  endfor
endif
...
if has('terminal')
  ...
  for s:i in range(16)
    call add(g:terminal_ansi_colors, g:yuri-dark#palette['color_' . s:i])
  endfor
endif
...
if !exists('g:yuri-dark_bold')
  let g:yuri-dark_bold = 1
endif

if !exists('g:yuri-dark_italic')
  let g:yuri-dark_italic = 1
endif

if !exists('g:yuri-dark_underline')
  let g:yuri-dark_underline = 1
endif

if !exists('g:yuri-dark_undercurl') && g:yuri-dark_underline != 0
  let g:yuri-dark_undercurl = 1
endif

if !exists('g:yuri-dark_inverse')
  let g:yuri-dark_inverse = 1
endif

if !exists('g:yuri-dark_colorterm')
  let g:yuri-dark_colorterm = 1
endif
...
let s:attrs = {
      \ 'bold': g:yuri-dark_bold == 1 ? 'bold' : 0,
      \ 'italic': g:yuri-dark_italic == 1 ? 'italic' : 0,
      \ 'underline': g:yuri-dark_underline == 1 ? 'underline' : 0,
      \ 'undercurl': g:yuri-dark_undercurl == 1 ? 'undercurl' : 0,
      \ 'inverse': g:yuri-dark_inverse == 1 ? 'inverse' : 0,
      \}
...
call s:h('YuriDarkYellow', s:yellow)
call s:h('YuriDarkYellowItalic', s:yellow, s:none, [s:attrs.italic])
...
call s:h('Normal', s:fg, g:yuri-dark_colorterm || has('gui_running') ? s:bg : s:none )
...
hi! link CursorLineNr YuriDarkYellow
