...
if !exists("g:genos_termcolors")
  let g:genos_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:genos_terminal_italics")
  let g:genos_terminal_italics = 0
endif
...
let s:colors = genos#GetColors() " Autoloaded from the specific color theme
