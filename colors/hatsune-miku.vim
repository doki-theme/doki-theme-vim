...
let g:colors_name = 'hatsune-miku'
...
let s:bglighter = g:hatsune-miku#palette.bglighter
let s:bglight   = g:hatsune-miku#palette.bglight
let s:bg        = g:hatsune-miku#palette.bg
let s:bgdark    = g:hatsune-miku#palette.bgdark
let s:bgdarker  = g:hatsune-miku#palette.bgdarker

let s:comment   = g:hatsune-miku#palette.comment
let s:selection = g:hatsune-miku#palette.selection
let s:subtle    = g:hatsune-miku#palette.subtle

let s:cyan      = g:hatsune-miku#palette.cyan
let s:green     = g:hatsune-miku#palette.green
let s:orange    = g:hatsune-miku#palette.orange
let s:pink      = g:hatsune-miku#palette.pink
let s:purple    = g:hatsune-miku#palette.purple
let s:red       = g:hatsune-miku#palette.red
let s:yellow    = g:hatsune-miku#palette.yellow

let s:none      = ['NONE', 'NONE']

if has('nvim')
  for s:i in range(16)
    let g:terminal_color_{s:i} = g:hatsune-miku#palette['color_' . s:i]
  endfor
endif
...
if has('terminal')
  ...
  for s:i in range(16)
    call add(g:terminal_ansi_colors, g:hatsune-miku#palette['color_' . s:i])
  endfor
endif
...
if !exists('g:hatsune-miku_italic')
  let g:hatsune-miku_italic = 1
endif

if !exists('g:hatsune-miku_underline')
...
if !exists('g:hatsune-miku_inverse')
  let g:hatsune-miku_inverse = 1
endif

if !exists('g:hatsune-miku_colorterm')
  let g:hatsune-miku_colorterm = 1
endif
...
let s:attrs = {
      ...
      \ 'undercurl': g:hatsune-miku_undercurl == 1 ? 'undercurl' : 0,
      \ 'inverse': g:hatsune-miku_inverse == 1 ? 'inverse' : 0,
      \}
...
call s:h('HatsuneMikuYellow', s:yellow)
call s:h('HatsuneMikuYellowItalic', s:yellow, s:none, [s:attrs.italic])
...
call s:h('Normal', s:fg, g:hatsune-miku_colorterm || has('gui_running') ? s:bg : s:none )
...
hi! link CursorLineNr HatsuneMikuYellow
...
hi! link String HatsuneMikuYellow
