...
if !exists("g:senko_termcolors")
  let g:senko_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:senko_terminal_italics")
  let g:senko_terminal_italics = 0
endif
...
let s:colors = senko#GetColors() " Autoloaded from the specific color theme
